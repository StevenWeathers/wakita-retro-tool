...
<svelte:head>
    <title>Wakita - Open Source Agile Sprint Retrospective Tool</title>
</svelte:head>
        ...
        <div class="flex flex-wrap items-center -mx-4">
            <div class="w-full md:w-1/2 mb-4 lg:mb-0 px-4 text-white">
                <h1 class="mb-2 lg:mb-4 text-4xl font-bold leading-tight">
                    Wakita is an open source Agile Sprint Retrospective tool
                </h1>
    ...
    <div class="container mx-auto px-4 py-6 lg:py-10">
        ...
        <div class="flex text-center mb-8">
            ...
            <div class="w-1/2">
                ...
                <p class="px-2">
                    <a href="https://wakita.dev" class="feature-link">
                        Wakita.dev
                    </a>
                    is a free hosted service (SaaS) without Ads, alternatively
                    you can
                    <a
                        href="https://github.com/StevenWeathers/wakita-retro-tool#running-in-production"
                        class="feature-link">
        ...
        <div class="flex text-center mb-8">
            <div class="w-1/2">
                ...
                <p class="px-2">
                    Wakita is fast and small (under 20mb single executable)
                    thanks to
                    ...
                    <span class="font-bold">
                        Over 30 active users in a retrospective tested!
                    </span>
                </p>
            </div>
            <div class="w-1/2">
